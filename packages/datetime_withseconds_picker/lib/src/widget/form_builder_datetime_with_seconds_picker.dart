...
class FormBuilderDateTimeWithSecondsPicker extends FormBuilderField<DateTime> {
  ...
  FormBuilderDateTimeWithSecondsPicker({
    ...
    this.initialTime = const TimeOfDayWithSec(hour: 12, minute: 0, second: 0),
    ...
    this.onEntryModeChanged,
          ...
          builder: (FormFieldState<DateTime?> field) {
            final state = field as _FormBuilderDateTimeWithSecondsPickerState;
  ...
  @override
  FormBuilderFieldState<FormBuilderDateTimeWithSecondsPicker, DateTime>
      createState() => _FormBuilderDateTimeWithSecondsPickerState();
}

class _FormBuilderDateTimeWithSecondsPickerState extends FormBuilderFieldState<
    FormBuilderDateTimeWithSecondsPicker, DateTime> {
  ...
  Future<TimeOfDayWithSec?> _showTimePicker(
      BuildContext context, DateTime? currentValue) async {
    final timePickerResult = await showTimeWithSecPicker(
      context: context,
      initialTime: currentValue != null
          ? TimeOfDayWithSec.fromDateTime(currentValue)
          : widget.initialTime,
      builder: widget.transitionBuilder,
      useRootNavigator: widget.useRootNavigator,
      routeSettings: widget.routeSettings,
  ...
  /// Sets the hour and minute of a [DateTime] from a [TimeOfDayWithSec].
  DateTime combine(DateTime date, TimeOfDayWithSec? time) => DateTime(
      date.year,
      date.month,
      date.day,
      time?.hour ?? 0,
  ...
  DateTime? convert(TimeOfDayWithSec? time) => time == null
      ? null
      : DateTime(1, 1, 1, time.hour, time.minute, time.second);
